...
var TOKEN_DIR = './super-secrets/'                                    // where you saved your token
var TOKEN_PATH = TOKEN_DIR + 'youtube-nodejs-quickstart.json';
const TAKE_THIS_API_KEY_OUT = ''
...
// Load token from local file, authorize client, then call YT's API.
fs.readFile('client-secret.json', function processClientSecrets(err, content) {
    if (err) {
        console.error(`Failed to load secret file (token) -> ${err}`);
        return;
    }
